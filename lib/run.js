...
var require_io_util = __commonJS({
  "node_modules/@actions/io/lib/io-util.js"(exports2) {
    ...
    var fs2 = require("fs");
    var path2 = require("path");
    _a = fs2.promises, exports2.copyFile = _a.copyFile, exports2.lstat = _a.lstat, exports2.mkdir = _a.mkdir, exports2.readdir = _a.readdir, exports2.rmdir = _a.rmdir, exports2.stat = _a.stat, exports2.unlink = _a.unlink;
      ...
      return __awaiter2(this, void 0, void 0, function* () {
        if (yield ioUtil.isDirectory(source)) {
          ...
          for (const newSource of sourceChildren) {
            const newDest = path2.join(dest, path2.basename(newSource));
            yield copyDirectoryContents(path2.resolve(source, newSource), newDest, force, deleteOriginal);
          }
          if (deleteOriginal) {
          ...
          if (force) {
            ...
            yield ioUtil.copyFile(source, dest, fs2.constants.COPYFILE_EXCL);
          }
          if (deleteOriginal) {
...
var require_tool_cache = __commonJS({
  "node_modules/@actions/tool-cache/lib/tool-cache.js"(exports2) {
    ...
    var cacheRoot = process.env["RUNNER_TOOLSDIRECTORY"] || "";
      ...
      return __awaiter2(this, void 0, void 0, function* () {
        return new Promise((resolve, reject) => __awaiter2(this, void 0, void 0, function* () {
          try {
            ...
            yield io2.mkdirP(tempDirectory);
            ...
            file.on("open", () => __awaiter2(this, void 0, void 0, function* () {
              try {
    ...
    function extractTar(file, dest) {
      return __awaiter2(this, void 0, void 0, function* () {
        ...
        dest = dest || (yield _createExtractFolder(dest));
        const tarPath = yield io2.which("tar", true);
    ...
    function extractZipWin(file, dest) {
      return __awaiter2(this, void 0, void 0, function* () {
        ...
        const powershellPath = yield io2.which("powershell");
        const args = [
          "-NoLogo",
          "-Sta",
          "-NoProfile",
    ...
    function extractZipNix(file, dest) {
      return __awaiter2(this, void 0, void 0, function* () {
        const unzipPath = path2.join(__dirname, "..", "scripts", "externals", "unzip");
